    ...
    return html`
        <section class="relative isolate overflow-hidden font-dm min-h-screen flex flex-col justify-center bg-white/[0.44] dark:bg-white/[0.045] backdrop-blur-2xl">
            ...
            <div class="relative flex flex-col items-center justify-center pt-28 sm:pt-32 pb-16 sm:pb-24 px-5 text-center">
                ...
                <!-- Brand eyebrow -->
                <span class="mb-6 text-xs font-semibold tracking-[0.2em] uppercase text-purple-600 dark:text-purple-400">
                    Dota Framework
                </span>
                ...
                <h1 class="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold
                    ...
                    Web Components,
                    <br/>
                    <span class="text-purple-600 dark:text-purple-400">done right.</span>
                </h1>

                <!-- Subheadline -->
                <p class="mt-5 text-gray-800 dark:text-gray-200 text-sm sm:text-lg w-full max-w-lg leading-relaxed font-normal">
                ...
                <div class="mt-9 flex flex-wrap items-center justify-center gap-2">
                    <span class="inline-flex items-center px-3 py-1.5 rounded-lg
                                 ...
                                 text-xs font-mono font-medium text-purple-600 dark:text-purple-400">
                        @Component
                    </span>
                    <span class="inline-flex items-center px-3 py-1.5 rounded-lg
                                 bg-white/55 dark:bg-white/[0.055] backdrop-blur-xl
                    ...
                    <span class="text-gray-200 dark:text-gray-700 select-none px-0.5">&middot;</span>
                    <span class="inline-flex items-center px-3 py-1.5 rounded-lg
                                 bg-white/55 dark:bg-white/[0.055] backdrop-blur-xl
                                 border border-white/70 dark:border-white/10
                                 shadow-[0_12px_40px_-30px_rgba(15,23,42,0.7)]
                ...
                <div class="mt-8 flex w-full max-w-xs sm:max-w-sm items-center gap-2 px-4 py-2.5 rounded-xl
                    ...
                    <code class="flex-1 min-w-0 truncate text-xs sm:text-sm font-mono text-gray-700 dark:text-gray-300 select-all text-left">
