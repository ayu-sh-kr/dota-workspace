            ...
            <div class="grid md:grid-cols-2 gap-x-20 gap-y-10 place-items-center justify-items-center">
                ...
                <div class="space-y-5 order-1 lg:order-2">
                    ...
                    <p class="text-gray-600 dark:text-gray-400 font-light lg:text-2xl md:text-xl text-lg">
                        Event Emitters <span class="text-purple-500 font-semibold italic">@Emitter</span> are a core
                        part of Dota-Core and are used to handle events in a decoupled way.
                        They allow you to emit events, making it easy to emit custom events and listen for them in
